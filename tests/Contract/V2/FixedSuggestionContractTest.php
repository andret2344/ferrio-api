...
/**
 * Contract for the fixed suggestion endpoint: POST /v2/missing/fixed + GET /v2/missing/{userId}/fixed.
 */
class FixedSuggestionContractTest extends ContractTestCase
{
	private const string CONTRACT = 'v2/fixed_suggestion';
	...
	public function testGenerationContract(string $generation): void
	{
		...
		$this->request('POST', '/v2/missing/fixed', [], $payload);
		$this->assertResponseStatusCodeSame(201);

		$this->request('GET', "/v2/missing/$userId/fixed");
