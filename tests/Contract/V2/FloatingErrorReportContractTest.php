...
/**
 * Contract for the floating error report endpoint: POST /v2/report/floating + GET /v2/report/{userId}/floating.
 */
class FloatingErrorReportContractTest extends ContractTestCase
{
	private const string CONTRACT = 'v2/floating_error';
	...
	public function testGenerationContract(string $generation): void
	{
		...
		$this->request('POST', '/v2/report/floating', [], $payload);
		$this->assertResponseStatusCodeSame(201);

		$this->request('GET', "/v2/report/$userId/floating");
