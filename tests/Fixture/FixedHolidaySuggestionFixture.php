...
class FixedHolidaySuggestionFixture extends Fixture implements DependentFixtureInterface
{
	...
	public function load(ObjectManager $manager): void
	{
		...
		$suggestion = new FixedHolidaySuggestion('user-id', 'Test name', 'Test description', 1, 1, $country, new DateTimeImmutable("2024-06-06 20:30:40"), ReportState::REPORTED, null, 'Duplicate of #42');
